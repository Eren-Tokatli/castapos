// Türkiye 81 il ve ilçeleri — adres formunda İl/İlçe seçimi için.
// Kaynak: topluluk tarafından derlenen genel bir il-ilçe listesi (resmi TÜİK verisiyle
// birebir eşleşmeyebilir; eksik bir ilçe fark edilirse eklenebilir).
...
export const TURKEY_PROVINCE_NAMES: string[] = Object.keys(TURKEY_PROVINCES);
