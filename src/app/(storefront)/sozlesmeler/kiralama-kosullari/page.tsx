...
export const metadata: Metadata = {
  title: "Kiralama Koşulları Sözleşmesi | Castapos",
  description: "Castapos kiralama koşulları — üyelik sistemi, hizmet alımı, cayma hakkı, fikri mülkiyet ve temerrüt faizi hükümleri.",
};

// Bu sayfa daha önce hiç yoktu — sepet checkout'undaki zorunlu "Kiralama
// Koşulları Sözleşmesi" onay kutusu /sozlesmeler/kiralama-kosullari'ye link
// veriyordu ama sayfa mevcut değildi (404). İçerik castapos.com'daki resmi
// Kullanım Şartları metninden alınmıştır — platformun kiralama koşullarını
// (üyelik, hizmet alımı, cayma hakkı, temerrüt faizi) düzenleyen belge budur.
...
export default function KiralamaKosullariPage() {
  return (
    <>
      <InfoPageBodyClass className="page-kiralama-kosullari" />

      <section className="listing-head account-hero info-doc-hero">
        <div className="container listing-head-inner">
          <div>
            <nav className="breadcrumb">
              <Link href="/">Ana Sayfa</Link> › Kiralama Koşulları Sözleşmesi
            </nav>
            <h1>Kiralama Koşulları Sözleşmesi</h1>
            <p>Üyelik sistemi, hizmet alımı, cayma hakkı ve kiralama sürecine ilişkin temel kurallar.</p>
          </div>
        </div>
      </section>
